...
begin
    ...
    ax1 = Axis(grid_left[1,1], ylabel = "EC RC-slab kgCO2e/m²", title="a) Slab sizing", aspect=1, limits=(0,max_steel,0,max_slab), yticklabelsize = fontsize, xticklabelsize = fontsize, xlabelsize = fontsize, ylabelsize = fontsize, titlesize = fontsize);
    ...
    ax2 = Axis(grid_left[1,2], title="b) Beam sizing", aspect=1, limits=(0,max_steel,0,max_slab), yticklabelsize = fontsize, xticklabelsize = fontsize, xlabelsize = fontsize, ylabelsize = fontsize, titlesize = fontsize);
    ...
    ax3 = Axis(grid_left[2,1], xlabel = "EC steel kgCO2e/m²", ylabel = "EC RC-slab kgCO2e/m²", title="c) Beam collinearity", aspect=1, limits=(0,max_steel,0,max_slab), yticklabelsize = fontsize, xticklabelsize = fontsize, xlabelsize = fontsize, ylabelsize = fontsize, titlesize = fontsize);
    ...
    ax4 = Axis(grid_left[2,2], xlabel = "EC steel kgCO2e/m²", title="d) Assembly depth", aspect=1, limits=(0,max_steel,0,max_slab), yticklabelsize = fontsize, xticklabelsize = fontsize, xlabelsize = fontsize, ylabelsize = fontsize, titlesize = fontsize);
    ...
    ax5 = Axis(grid_right[1,1], aspect = 1, xlabel = "EC steel kgCO2e/m²", ylabel = "EC RC-slab kgCO2e/m²", title="e) Slab Types", limits=(0,max_steel,0,max_slab), yticklabelsize = fontsize, xticklabelsize = fontsize, xlabelsize = fontsize, ylabelsize = fontsize, titlesize = fontsize);
    ...
    display(fig) 
    save("figures/multiplot.pdf", fig)
