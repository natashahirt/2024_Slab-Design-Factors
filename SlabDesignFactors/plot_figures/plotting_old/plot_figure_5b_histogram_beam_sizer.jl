...
begin
    ...
    df_names = DataFrame(name=String[], depth=Float64[], mass=Float64[], area=Float64[], beam_sizer=String[])
    ...
    for beam_sizer in ["discrete", "continuous"]
        ...
        for W_id in W_ids
            ...
            push!(df_names, (W_id, W_depth, W_mass, W_area, beam_sizer))
        end
    ...
    println(length(df_filtered.area))
    ...
    display(fig)
    save("figures/sections histogram.pdf", fig)
